...
pub const DOD_CONSTANTS = struct {
    ...
    pub const MAX_KEYS = 32; // 32 keys
    pub const MAX_VALUES = 24; // 24 values (enough for 12 conversations)
    pub const MAX_METADATA = 8; // 8 metadata entries
    pub const MAX_STATS = 8; // 8 stats entries
    pub const MAX_PREFETCH = 8; // 8 prefetch entries
