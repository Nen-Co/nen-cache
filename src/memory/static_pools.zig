...
pub const GPUMemoryPool = struct {
    ...
    pub fn init() !GPUMemoryPool {
        const pool = try StaticMemoryPool.init(STATIC_POOL_SIZES.GPU_ENTRY_SIZE, STATIC_POOL_SIZES.GPU_ENTRIES);
...
pub const CPUMemoryPool = struct {
    ...
    pub fn init() !CPUMemoryPool {
        const pool = try StaticMemoryPool.init(STATIC_POOL_SIZES.CPU_ENTRY_SIZE, STATIC_POOL_SIZES.CPU_ENTRIES);
...
pub const NVMEMemoryPool = struct {
    ...
    pub fn init() !NVMEMemoryPool {
        const pool = try StaticMemoryPool.init(STATIC_POOL_SIZES.NVME_ENTRY_SIZE, STATIC_POOL_SIZES.NVME_ENTRIES);
...
pub const DiskMemoryPool = struct {
    ...
    pub fn init() !DiskMemoryPool {
        const pool = try StaticMemoryPool.init(STATIC_POOL_SIZES.DISK_ENTRY_SIZE, STATIC_POOL_SIZES.DISK_ENTRIES);
