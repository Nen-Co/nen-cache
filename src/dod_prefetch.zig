...
pub const CachePrefetchSystem = struct {
    ...
    // GPU prefetching
    pub fn prefetchGPUData(
        self: *CachePrefetchSystem,
        cache_layout: *const dod_layout.DODCacheLayout,
        key_indices: []const u32,
        hint: CachePrefetchHint
    ) void {
