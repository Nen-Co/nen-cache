...
pub fn build(b: *std.Build) void {
    ...
    const full_stack_demo = b.addExecutable(.{
        ...
        .root_source_file = .{ .cwd_relative = "examples/full_stack_demo.zig" },
        .target = target,
        .optimize = optimize,
    });
    ...
    const nendb_demo = b.addExecutable(.{
        .name = "nendb-demo",
        .root_source_file = .{ .cwd_relative = "examples/nendb_integration_demo.zig" },
        .target = target,
        .optimize = optimize,
    });
    ...
    // NenDB cache layer demo
    const nendb_cache_demo = b.addExecutable(.{
        .name = "nendb-cache-demo",
        .root_source_file = .{ .cwd_relative = "examples/nendb_cache_layer_demo.zig" },
        .target = target,
        .optimize = optimize,
    });
    ...
    // Nen integration test
    const nen_test = b.addExecutable(.{
        .name = "nen-test",
        .root_source_file = .{ .cwd_relative = "test_nen_integration.zig" },
        .target = target,
        .optimize = optimize,
    });
    ...
    const llama_test = b.addExecutable(.{
        .name = "llama-test",
        .root_source_file = .{ .cwd_relative = "test_llama_integration.zig" },
        .target = target,
        .optimize = optimize,
    });
